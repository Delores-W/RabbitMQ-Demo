...
import com.heylee.demo.risk_service.model.Account4AMQP;
import com.heylee.demo.risk_service.model.Response.AccountsResponse;
import com.heylee.demo.risk_service.model.Response.OperationResponse;
import com.heylee.demo.risk_service.repo.AccountRepo;
...
public class AccountController {
    ...
    public void processMessage(String message) {
        ...
        if (object.getString("method").equals("POST")) {
    ...
    public OperationResponse edit(@RequestBody Account vo) {
        ...
        if (account == null) {
            ...
            account4AMQP.setMethod(RequestMethod.PUT);
